...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Keynold"
    user-mail-address "nqphu1998@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/harvey/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/harvey/bin" "/profile/bin" "/Users/harvey/.npm-packages/bin" "/Users/harvey/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
